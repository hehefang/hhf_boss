...
import com.hhf.common.config.HhfConfig;
...
import com.hhf.staff.dao.TStaffMapper;
import com.hhf.staff.dao.TStaffRoleMapper;
import com.hhf.staff.dao.extend.TStaffPrivilegeMapper;
import com.hhf.staff.model.TResource;
import com.hhf.staff.model.TStaff;
import com.hhf.staff.model.TStaffExample;
import com.hhf.staff.model.TStaffRole;
import com.hhf.staff.model.TStaffRoleExample;
import com.hhf.staff.service.StaffService;
...
public class StaffServiceImpl implements StaffService {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.hhf.staff.service.StaffService#getStaff(int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.hhf.staff.service.StaffService#getStaffPrivileges(int)
	 */
	@Override
	...
	public Integer newStaff(TStaff staff) {
		...
		staff.setPassword(MD5Encrypt.md5(staff.getPrivateKey(),
				HhfConfig.seller_default_password));
	...
	public void resetStaffPassword(int staffId) {
		...
		staffMapper.updateStaffPassword(staffId, MD5Encrypt.md5(
				staff.getPrivateKey(), HhfConfig.staff_default_password));
	}
