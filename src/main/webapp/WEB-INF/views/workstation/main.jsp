...
<%@ page import="java.util.List,com.hhf.staff.model.extend.TResourceExtend, com.hhf.staff.model.*, com.google.common.collect.Lists, org.apache.shiro.SecurityUtils"%>

<%!
com.hhf.staff.service.StaffService staffService = com.hhf.common.spring.SpringContextUtil.getApplicationContext().getBean(com.hhf.staff.service.StaffService.class);
com.hhf.staff.service.ResourceService resourceService = com.hhf.common.spring.SpringContextUtil.getApplicationContext().getBean(com.hhf.staff.service.ResourceService.class);
...
<title><decorator:title default="禾合坊BOSS管理系统"/></title>
...
<body>
	<div class="wrapper">
		<div id="hd">
        	<div class="header">
				<h1><a href="#" title="">禾合坊</a><span>后台管理系统</span></h1>
        ...
        <div id="footer">
	        <div class="links">
				...
				<p class="copyright">Copyright © 2013-2015 hehefang.com All Rights Reserved.</p>
