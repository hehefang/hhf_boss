<%-- <%@page import="com.hhf.common.util.DateUtils"%>
...
<%
com.hhf.boss.web.YwProdPromotionController.FormData data = (com.hhf.boss.web.YwProdPromotionController.FormData)request.getAttribute("data");
									...
									<tr>
										...
										<td>
		                                    <dl class="o-goodsName">		           
		                                    	...
		                                    	<dd>
		                                    		<a href="http://item.hhf.com/detail/${detail.skuId}.html" target="_blank"><c:out value="${detail.prodTitle}"/></a>
										...
										<td class="align-l"><a href="http://shop.hhf.com/${detail.storeId}/" target="_blank"><c:out value="${detail.storeName}"/></a></td>
...
function addSku(sku) {
	...
	tr = tr + '<dd>	<a href="http://item.hhf.com/detail/' + sku.skuId + '.html" target="_blank">' 
		...
		+ '<td class="align-l"><a href="http://shop.hhf.com/' + sku.storeId + '/" target="_blank">' + sku.storeName + '</a></td>';
