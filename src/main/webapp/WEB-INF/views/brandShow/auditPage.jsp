		...
		<div class="bd">
			<div class="pop-con">
				...
				<dl>
					...
					<dd>
						<input type="text" class="txt" style="width: 174px;" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss', autoPickDate:true, minDate:'<%= com.hhf.common.util.DateUtils.formatDate(com.hhf.common.util.DateUtils.currentDate()) %>'});" name="startDate" id="startDate"/>						
					</dd>
				</dl>
				<dl>
					<dt><label><em>*</em>专场结束时间：</label></dt>
					<dd>
						<input type="text" class="txt" style="width: 174px;" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss', autoPickDate:true, minDate:'<%= com.hhf.common.util.DateUtils.formatDate(com.hhf.common.util.DateUtils.currentDate()) %>'});" name="endDate" id="endDate"/>						
					</dd>
				</dl>
			</div>
			<div class="formBtn">
